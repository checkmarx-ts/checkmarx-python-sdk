...
from .dto.AuthenticationExecutionInfoRepresentation import (
    AuthenticationExecutionInfoRepresentation,
)
from .dto.AuthenticationExecutionRepresentation import (
    AuthenticationExecutionRepresentation,
)
from .dto.AuthenticationFlowRepresentation import AuthenticationFlowRepresentation
from .dto.AuthenticatorConfigInfoRepresentation import (
    AuthenticatorConfigInfoRepresentation,
)
from .dto.AuthenticatorConfigRepresentation import AuthenticatorConfigRepresentation
from .dto.RequiredActionProviderRepresentation import (
...
class AuthenticationManagementApi:
    ...
    def get_execution_config(
        self, realm: str, execution_id: str, id: str
    ) -> AuthenticatorConfigRepresentation:
        """
