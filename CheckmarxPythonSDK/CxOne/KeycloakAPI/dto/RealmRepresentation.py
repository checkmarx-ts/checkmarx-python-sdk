...
class RealmRepresentation:
    ...
    user_federation_providers: Optional[List[UserFederationProviderRepresentation]] = (
        None
    )
    ...
    identity_provider_mappers: Optional[List[IdentityProviderMapperRepresentation]] = (
        None
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if (
            self.web_authn_policy_passwordless_attestation_conveyance_preference
            is not None
        ):
        ...
        if (
            self.web_authn_policy_passwordless_avoid_same_authenticator_register
            is not None
        ):
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "RealmRepresentation":
        ...
        if "default_role" in snake_data and snake_data["default_role"] is not None:
            snake_data["default_role"] = RoleRepresentation.from_dict(
                snake_data["default_role"]
            )
        if (
            "client_profiles" in snake_data
            and snake_data["client_profiles"] is not None
        ):
            snake_data["client_profiles"] = ClientProfilesRepresentation.from_dict(
                snake_data["client_profiles"]
            )
        if (
            "client_policies" in snake_data
            and snake_data["client_policies"] is not None
        ):
            snake_data["client_policies"] = ClientPoliciesRepresentation.from_dict(
                snake_data["client_policies"]
            )
        ...
        if (
            "federated_users" in snake_data
            and snake_data["federated_users"] is not None
        ):
            snake_data["federated_users"] = [
                UserRepresentation.from_dict(item)
                for item in snake_data["federated_users"]
            ]
        if "scope_mappings" in snake_data and snake_data["scope_mappings"] is not None:
            snake_data["scope_mappings"] = [
                ScopeMappingRepresentation.from_dict(item)
                for item in snake_data["scope_mappings"]
            ]
        ...
        if "client_scopes" in snake_data and snake_data["client_scopes"] is not None:
            snake_data["client_scopes"] = [
                ClientScopeRepresentation.from_dict(item)
                for item in snake_data["client_scopes"]
            ]
        if (
            "user_federation_providers" in snake_data
            and snake_data["user_federation_providers"] is not None
        ):
            snake_data["user_federation_providers"] = [
                UserFederationProviderRepresentation.from_dict(item)
                for item in snake_data["user_federation_providers"]
            ]
        if (
            "user_federation_mappers" in snake_data
            and snake_data["user_federation_mappers"] is not None
        ):
            snake_data["user_federation_mappers"] = [
                UserFederationMapperRepresentation.from_dict(item)
                for item in snake_data["user_federation_mappers"]
            ]
        if (
            "identity_providers" in snake_data
            and snake_data["identity_providers"] is not None
        ):
            snake_data["identity_providers"] = [
                IdentityProviderRepresentation.from_dict(item)
                for item in snake_data["identity_providers"]
            ]
        if (
            "identity_provider_mappers" in snake_data
            and snake_data["identity_provider_mappers"] is not None
        ):
            snake_data["identity_provider_mappers"] = [
                IdentityProviderMapperRepresentation.from_dict(item)
                for item in snake_data["identity_provider_mappers"]
            ]
        if (
        ...
        if (
            "authentication_flows" in snake_data
            and snake_data["authentication_flows"] is not None
        ):
            snake_data["authentication_flows"] = [
                AuthenticationFlowRepresentation.from_dict(item)
                for item in snake_data["authentication_flows"]
            ]
        if (
            "authenticator_config" in snake_data
            and snake_data["authenticator_config"] is not None
        ):
            snake_data["authenticator_config"] = [
                AuthenticatorConfigRepresentation.from_dict(item)
                for item in snake_data["authenticator_config"]
            ]
        if (
            "required_actions" in snake_data
            and snake_data["required_actions"] is not None
        ):
            snake_data["required_actions"] = [
                RequiredActionProviderRepresentation.from_dict(item)
                for item in snake_data["required_actions"]
            ]
        if "applications" in snake_data and snake_data["applications"] is not None:
            snake_data["applications"] = [
                ApplicationRepresentation.from_dict(item)
                for item in snake_data["applications"]
            ]
        if "oauth_clients" in snake_data and snake_data["oauth_clients"] is not None:
            snake_data["oauth_clients"] = [
                OAuthClientRepresentation.from_dict(item)
                for item in snake_data["oauth_clients"]
            ]
        if (
            "client_templates" in snake_data
            and snake_data["client_templates"] is not None
        ):
            snake_data["client_templates"] = [
                ClientTemplateRepresentation.from_dict(item)
                for item in snake_data["client_templates"]
            ]
        required_fields = []
