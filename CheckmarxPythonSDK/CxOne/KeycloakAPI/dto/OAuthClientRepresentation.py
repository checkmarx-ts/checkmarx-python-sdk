...
class OAuthClientRepresentation:
    ...
    claims: Optional[ApplicationRepresentationClaims] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.claims is not None:
            value = self.claims.to_dict()
            result["claims"] = value
        return result

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "OAuthClientRepresentation":
        ...
        if "claims" in snake_data and snake_data["claims"] is not None:
            snake_data["claims"] = ApplicationRepresentationClaims.from_dict(
                snake_data["claims"]
            )
        if (
