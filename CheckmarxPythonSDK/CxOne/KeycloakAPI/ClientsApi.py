...
class ClientsApi:
    ...
    def get_clients(
        ...
        return [
            ClientRepresentation.from_dict(item) for item in response.json()
        ]
    ...
    def put_default_client_scope(
        ...
        """
        relative_url = f"{api_url}/{realm}/clients/{id}/default-client-scopes/{client_scope_id}"
        response = self.api_client.put_request(
            relative_url=relative_url, 
            is_iam=True
        )
    ...
    def get_generate_example_id_token(
        ...
        """
        params = {"scope": scope, "userId": user_id}
        relative_url = f"{api_url}/{realm}/clients/{id}/evaluate-scopes/generate-example-id-token"
        response = self.api_client.get_request(
            relative_url=relative_url, 
            params=params,
            is_iam=True
    ...
    def get_generate_example_userinfo(
        ...
        """
        params = {"scope": scope, "userId": user_id}
        relative_url = f"{api_url}/{realm}/clients/{id}/evaluate-scopes/generate-example-userinfo"
        response = self.api_client.get_request(
            relative_url=relative_url, 
            params=params,
            is_iam=True
    ...
    def get_protocol_mappers(
        ...
        """
        params = {"scope": scope}
        relative_url = f"{api_url}/{realm}/clients/{id}/evaluate-scopes/protocol-mappers"
        response = self.api_client.get_request(
            relative_url=relative_url, 
            params=params,
            is_iam=True
    ...
    def get_offline_sessions(
        ...
        return [
            UserSessionRepresentation.from_dict(item) for item in response.json()
        ]
    ...
    def put_optional_client_scope(self, 
            realm: str, 
            id: str, 
            client_scope_id: str
        ) -> bool:
        ...
        """
        relative_url = f"{api_url}/{realm}/clients/{id}/optional-client-scopes/{client_scope_id}"
        response = self.api_client.put_request(
            relative_url=relative_url, 
            is_iam=True
        )
    ...
    def delete_optional_client_scope(self, 
            realm: str, 
            id: str, 
            client_scope_id: str
        ) -> bool:
    ...
    def post_client_push_revocation(self, 
            realm: str, 
            id: str
        ) -> GlobalRequestResult:
        """
    ...
    def post_registration_access_token(self, 
            realm: str, 
            id: str
        ) -> ClientRepresentation:
        """
    ...
    def get_service_account_user(self, 
            realm: str, 
            id: str
        ) -> UserRepresentation:
        """
    ...
    def get_test_nodes_available(self, 
            realm: str, 
            id: str
        ) -> GlobalRequestResult:
        """
