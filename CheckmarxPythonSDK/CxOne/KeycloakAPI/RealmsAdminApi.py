...
class RealmsAdminApi:
    ...
    def put_by_realm(
        self, realm: str, realm_representation: RealmRepresentation
    ) -> bool:
        """
    ...
    def put_policies(
        self, realm: str, client_policies_representation: ClientPoliciesRepresentation
    ) -> bool:
        """
        ...
        Args:
            ...
            client_policies_representation
                (ClientPoliciesRepresentation): Request body data [required]
    ...
    def get_profiles(
        self, realm: str, include_global_profiles: str = None
    ...
    def put_profiles(
        self, realm: str, client_profiles_representation: ClientProfilesRepresentation
    ) -> bool:
        """
        ...
        Args:
            ...
            client_profiles_representation
                (ClientProfilesRepresentation): Request body data [required]
    ...
    def put_default_default_client_scope(
        self, realm: str, client_scope_id: str
    ) -> bool:
        """
    ...
    def get_localization_by_realm_by_locale(
        self, realm: str, locale: str, use_realm_default_locale_fallback: str = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_localization_by_realm_by_locale_by_key(
        self, realm: str, locale: str, key: str
    ) -> bool:
        """
    ...
    def post_partial_export(
        self,
        realm: str,
        export_clients: str = None,
        export_groups_and_roles: str = None,
    ) -> bool:
        """
    ...
    def put_users_management_permissions(
        self, realm: str, management_permission_reference: ManagementPermissionReference
    ) -> ManagementPermissionReference:
        """
