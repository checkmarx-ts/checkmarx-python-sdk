...
class ClientAttributeCertificateApi:
    ...
    def post_generate_and_download(
        ...
        """
        relative_url = f"{api_url}/{realm}/clients/{id}/certificates/{attr}/generate-and-download"
        response = self.api_client.post_request(
            relative_url=relative_url, 
            json=key_store_config.to_dict(),
            is_iam=True
    ...
    def post_upload_certificate(
        ...
        """
        relative_url = f"{api_url}/{realm}/clients/{id}/certificates/{attr}/upload-certificate"
        response = self.api_client.post_request(
            relative_url=relative_url, 
            is_iam=True
        )
