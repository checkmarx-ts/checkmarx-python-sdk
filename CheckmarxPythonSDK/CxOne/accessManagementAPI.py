...
class AccessManagementAPI(object):
    ...
    def update_assignment_roles(
            self, 
            entity_roles: EntityRolesRequest, 
            entity_id: str, 
            resource_id: str
        ) -> bool:
        """
    ...
    def retrieve_resource_assignments(
        ...
        params = {
            "resource-ids": ",".join(resource_ids) if resource_ids else None
        }
        response = self.api_client.call_api(
            method="GET",
            url=url, 
        ...
        return construct_assignments_for_resource(
            response.json()
        )
    ...
    def create_multiple_assignments(
        ...
        response = self.api_client.call_api(
            method="POST",
            url=url, 
            json=multiple_assignment.to_dict()
        )
        return response.status_code == CREATED

    def add_roles_to_assignment(
            self, 
    ...
    def retrieve_entities(
        ...
        return [
            construct_assignment(item) for item in response.json()
        ]
    ...
    def retrieve_resources(
        ...
        return [
            construct_assignment(assignment) for assignment in response.json()
        ]
    ...
    def get_a_list_of_permissions_of_entity_for_resource(
        ...
        return construct_effective_permissions_for_resource_response(
            response.json()
        )
    ...
    def retrieve_groups(
        ...
        return [
            construct_group(group) for group in response.json()
        ]
    ...
    def retrieve_users(
        ...
        return [
            construct_user(user) for user in response.json()
        ]
    ...
    def retrieve_clients(
        ...
        return [
            construct_client(client) for client in response.json()
        ]

    def retrieve_users_from_internal_am_storage(
            self
        ) -> dict:
        """
    ...
    def retrieve_groups_from_internal_am_storage(
            self
        ) -> dict:
        """
        Get info about OAuth clients in the tenant account.
    ...
    def retrieve_clients_from_internal_am_storage(
            self
        ) -> List[InternalClient]:
        """
        Get AM clients
        ...
        return [
            construct_internal_client(client) for client in response.json()
        ]

    def retrieve_entity_base_roles(
            self, 
            entity_id: str
        ) -> BaseRolesResponse:
        """
    ...
    def delete_base_roles_for_an_entity(
            self, 
            entity_id: str
        ) -> bool:
        """
    ...
    def retrieve_roles(
        ...
        return [
            construct_role_with_details(role) for role in response.json()
        ]
    ...
    def retrieve_permissions(
        ...
        return [
            construct_permission(permission) for permission in response.json()
        ]
...
def retrieve_entity_base_roles(
    ...
    return AccessManagementAPI().retrieve_entity_base_roles(
        entity_id=entity_id
    )
...
def delete_base_roles_for_an_entity(
    ...
    return AccessManagementAPI().delete_base_roles_for_an_entity(
        entity_id
    )
...
def create_a_role(
    ...
    return AccessManagementAPI().create_a_role(
...
def retrieve_role(
    ...
    return AccessManagementAPI().retrieve_role(
        role_id=role_id
    )
...
def delete_a_role(
    ...
    return AccessManagementAPI().delete_a_role(
        role_id=role_id
    )
