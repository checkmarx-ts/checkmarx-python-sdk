                    ...
                    try:
                        ...
                        if len(non_composite_roles) > 0:
                            ...
                            try:
                                ...
                                composites = (
                                    self.roles_by_id_api.get_roles_by_id_composites(
                                        self.realm, self.test_role_id
                                    )
                                )
        ...
        try:
            ...
            try:
                ...
                if len(roles) > 0:
                    ...
                    try:
                        permissions = (
                            self.roles_by_id_api.get_roles_by_id_management_permissions(
                                self.realm, self.test_role_id
                            )
                        )
                        ...
                        permission_reference = ManagementPermissionReference(
                            enabled=True
                        )
                        updated_permissions = (
                            self.roles_by_id_api.put_roles_by_id_management_permissions(
