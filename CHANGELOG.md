...
* [Update] Align setup.py install_requires floors with requirements.txt (httpx>=0.28.1, suds-community>=1.2.0)
...
* [Add] Identify the SDK in the User-Agent header (checkmarx-python-sdk/<version>) so CxOne attributes scans to the SDK instead of python-httpx
...
* [Add] test_access_management_api.py::test_retrieve_entities
* [Add] test_access_management_api.py::test_check_access
* Merge pull request #182 from yangy-23/master
...
* [Fix] RolesByIdApi and RoleMapperApi incorrect URLs
...
1.6.2 - 2025-11-14
* Fix repoManagerAPI ossfScoreCardScannerEnabled and secretsDetectionScannerEnabled typo issue
